...
angular.module("project3App").controller("sellersDetailsController", ["$scope", "AppResource", "$routeParams", "ProductDlg", "centrisNotify",
function sellersDetailsController($scope, AppResource, $routeParams, ProductDlg, centrisNotify) {
